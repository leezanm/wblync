<x-app-layout>
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
            ...
            <div>
                <div class="flex items-center gap-3">
                    ...
                    <span
                        class="inline-flex items-center px-3 py-1.5 rounded-full bg-green-100 text-green-700 text-xs font-bold">
                        {{ $monitoring->status }}
                    </span>

                    <span class="text-sm text-slate-400">
                        Visit {{ $monitoring->monitoring_no }} / 3
                    </span>
                </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-6">
            ...
            <div class="p-6 bg-slate-50 border-b border-slate-200">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div
                        class="w-10 h-10 rounded-xl bg-blue-600 text-white flex items-center justify-center font-bold shrink-0">
                        {{ $section->section_no }}
                    </div>
                            ...
                            <div class="mt-4 space-y-3">
                                ...
                                @foreach ($item->options as $option)
                                    ...
                                    <div
                                        ...
                                        {{ $selected ? 'border-blue-500 bg-blue-50 ring-1 ring-blue-500' : 'border-slate-200 bg-white' }}">
    ...
    <div class="flex justify-end mb-10">
        ...
        <a href="{{ route('lecturer.monitoring.visit', $monitoring->monitoring_no) }}"
