                    ...
                    @foreach ($students as $assignment)
                        ...
                        <div class="border border-slate-200 rounded-2xl p-5 hover:shadow-md transition">
                            ...
                            <div class="mt-5 pt-5 border-t border-slate-100 space-y-2">
                                ...
                                <a
                                    href="{{ route('lecturer.students.assessments.index', $assignment->student?->id) }}"
                                    class="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-600 text-white text-sm font-semibold hover:bg-emerald-700 transition"
                                >
