<x-app-layout>
    ...
    <div class="mx-auto max-w-4xl p-6">
        ...
        <form
            method="POST"
            action="{{ route(
                'assessment-rating-levels.update',
                [
                    'assessmentTemplate' =>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        type="number"
                        name="score"
                        value="{{ old('score', $ratingLevel->score) }}"
                        min="0"
                ...
                <div>
                    ...
                    <input
                        type="text"
                        name="label"
                        value="{{ old('label', $ratingLevel->label) }}"
                        required
                        class="mt-1 block w-full rounded-md border-gray-300"
                    >
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="mt-1 block w-full rounded-md border-gray-300"
                    >{{ old('description', $ratingLevel->description) }}</textarea>
                ...
                <div>
                    ...
                    <input
                        type="number"
                        name="sort_order"
                        value="{{ old('sort_order', $ratingLevel->sort_order) }}"
                        min="1"
                        required
                        class="mt-1 block w-full rounded-md border-gray-300"
                    >
